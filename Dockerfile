...
RUN wget --quiet https://repo.anaconda.com/miniconda/Miniconda3-latest-Linux-x86_64.sh -O ~/miniconda.sh && \
	...
	conda activate base && \
	conda install --yes cython numpy scipy pandas mkl mkl-devel msgpack-python && \
	conda install --yes -c conda-forge msgpack-c boost-cpp nlohmann_json pytest black flake8 && \
	conda clean --all --yes
